...
def main(top_k, save_path = '../../models/SPADE/', class_names = ['bottle', 'wood', 'screw']):
    """
    Run the model on the given classes and save the result to the given path.
    
    Args:
        top_k (int): The number of neighbors used for the k-NN comparison.
