...
from riad_functions.utils.funcs import EarlyStop, denorm
from riad_functions.utils.utils import time_file_str, time_string, convert_secs2time, AverageMeter, print_log
from riad_functions.utils.gen_mask import gen_mask
from riad_functions.models.unet import UNet
from riad_functions.losses.gms_loss import MSGMS_Loss
from riad_functions.losses.ssim_loss import SSIM_Loss
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='../../models/riad')
    ...
    # args.save_dir = './test_batch' + args.data_type + '/' + args.obj + '/seed_{}/'.format(args.seed)
    args.save_dir = './'+args.save_dir + '/' + args.obj + '/seed_{}_batch_{}_img_{}_kvalue_{}/'.format(args.seed, args.batch_size,args.img_size,args.name)
